...
export type Project = { id: string; name: string; path: string; labels: Label[]; documents: DatasetDocument[]; totalDocuments: number; page: number; pageSize: number; searchQuery?: string }
